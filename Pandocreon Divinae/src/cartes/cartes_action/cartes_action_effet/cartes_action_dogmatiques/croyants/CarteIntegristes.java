 ...
 */
public class CarteIntegristes extends CarteCroyant implements Effet {
	...
	private static class CarteIntegristesHolder {
		 ...
		 */
		private final static CarteIntegristes instance = new CarteIntegristes(Origine.JOUR, CarteIntegristesHolder.getDogmes(), 1);
		
		/**
		 * Methode permettant d'obtenir les dogmes de la carte
		 * @return {Dogme[]} : tableau de dogmes
		 */
		private static Dogme[] getDogmes() {
			return new Dogme[]{Dogme.HUMAIN, Dogme.NATURE, Dogme.CHAOS};
		}
	}
